...
export const TESTIMONIALS: Testimonial[] = [
  ...
  {
    body: "Beyond his technical abilities, Ayo is a collaborative and dependable teammate who fosters a positive work environment.",
    name: "Tom McDonough",
    role: "Co-founder & CTO",
    company: "Dexla",
    initials: "TM",
  ...
  {
    body: "He brought so much coolness to our project. Super creative, keen attention to details — our project even looks better than we imagined.",
    name: "Ibrahim Bashir",
    role: "CEO",
    company: "Techonstack",
    initials: "IB",
  ...
  {
    body: "His designs are not just visually sound but also done easy for implementation. Totally recommend.",
